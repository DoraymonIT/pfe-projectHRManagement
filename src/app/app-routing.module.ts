...
const routes: Routes = [
  ...
  {
    path: 'RhResponsable', children: [
      {path: 'overeview', component: OverreviewComponent },
      {path: 'absenceEtConge', component: AbsenceEtCongeComponent },
      {path: 'documentAdministrative', component: DocumentAdministrativeComponent}
    ]
  },
   {
    path: 'forgetPassword',
